export default function FeaturedShow() {
  return (
    <section className="h-[80vh] flex flex-col justify-end bg-[url(/images/header1.jpg)] p-16 text-white font-medium bg-cover">
      <div className="flex flex-col space-y-3 text-sm">
        ...
        <button className="self-start bg-blue-500 text-white px-4 py-1.5 rounded-lg">
          Watch Now
        </button>
      </div>
    </section>
